# wallpaper — Reverse Engineering Writeup

> **Challenge — "wallpaper"**
>
> *"The screensaver's neighbor. It too is hiding something behind its tiles."*
>
...
4. [Identifying the Puzzle](#2-identifying-the-puzzle)
5. [Extracting the Parameters](#3-extracting-the-parameters)
6. [The Validator Loop](#4-the-validator-loop)
7. [Solving the 15-Puzzle (A\*)](#5-solving-the-15-puzzle-a)
8. [Full Solver (PoC)](#6-full-solver-poc)
9. [Reproduction Steps](#7-reproduction-steps)
10. [Confirming the Flag](#8-confirming-the-flag)
11. [Appendix: Puzzle Walkthrough](#appendix-puzzle-walkthrough)
...
*(The solver may produce a different 37-move path on your machine due to heap tie-breaking order — both are accepted by the binary.)*
...
5. **Alternatively** — verify the puzzle simulation manually by tracing the first few moves in [Appendix: Puzzle Walkthrough](#appendix-puzzle-walkthrough).
